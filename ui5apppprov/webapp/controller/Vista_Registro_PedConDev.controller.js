sap.ui.define([
	...
	return Controller.extend("Proyecto_Portal_Proveedores.PORTAL_QAS_8.controller.Vista_Registro_PedConDev", {
...
var oModel = this.getView().getModel("myParam");
			...
			this.updateServicioTolerancia();
						...
						window.location.href = "https://portalproredondosprd-beaeaf19a.dispatcher.us1.hana.ondemand.com/?hc_reset";
					}
		},
											...
											for (var b = 0; b < itemsOC.length; b++) {
												...
												oModel.create("/" + this.varTableT_FAC_POS + "", llaveItem, {
													...
													success: function (data) {
														...
														var texto = "/T_OC_DETs(EM_RUC='" + this.varRucDeLaEmpresa + "',US_RUC='" + data.US_RUC + "',DE_POSICION='" +
															data.DE_POSICION +
		...
		btnAnadirDocSus: function () {
			...
			if (varSelecTipoCarga === "D") {
				varDocumentosObli = "07 - xml y 07 - pdf";
			}
