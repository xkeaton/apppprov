		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nspprovui5apppprov-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nspprovui5apppprov-display": {
								"semanticObject": "nspprovui5apppprov",
								"action": "display",
								"description": "portal proveedor",
								"title": "portal proveedor",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nspprov.ui5apppprov",
									"url": sap.ui.require.toUrl("nspprov/ui5apppprov")
								}
							}
						}
					}
